...
<div id="app">
    ...
    <div class="container padding-top">
        <div class="col-md-12">
            ...
            <ul class="horizontal-katalog">
            <?php while($loop = mysqli_fetch_array($brg)) { ?>
            <li>
            <div class="katalog-produk">
                <img class="image-katalog" src="public/img/<?php echo $loop['gambar'] ?>" alt="katalog">
                <h2><a href="beli.php?id_barang=<?php echo $loop['id_barang'] ?>&id_user=<?php echo $users['id_user'] ?>"><?php echo $loop['nama_barang'] ?></a></h2>
                <h4>Rp<?php echo number_format($loop['harga'], 0, ",", ".") ?></h4>
            </div>
            </li>
            <?php } ?>
            </ul>
